if (strcmpi(opt.method,'AMP') || (strcmpi(opt.method,'AMPhb') ) || (strcmpi(opt.method,'AMPhadamard') ) || (strcmpi(opt.method,'AMPhadamardSeeded') ) || (strcmpi(opt.method,'AMPhadamardSeededTranspose') ) )
...
if (strcmpi(opt.method,'AMPhadamardSeededTransposeA') )
